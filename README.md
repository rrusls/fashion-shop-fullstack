...
For me, this is a huge jump from konwing basic JS from college to learning and implementing new and more advanced JavaScript features, syntax and concepts in real projects, as well as getting experience in working with SQL commands in Python.
